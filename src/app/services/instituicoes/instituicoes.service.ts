...
export class InstituicoesService {
  ...
  #url = environment.apiAuth;
    ...
    public httpListInstituicao$(): Observable<IInstituicao[]> {
      return this.#http.get<IInstituicao[]>(`${this.#url}/api/instituicoes`).pipe(
        shareReplay(),
        tap((data) => {
    ...
    public httpListInstituicaoId$(id: number): Observable<IInstituicao[]> {
      return this.#http.get<IInstituicao[]>(`${this.#url}/api/instituicoes/${id}`).pipe(
        shareReplay(),
        tap((data) => {
    ...
    public httpRegisterInstituicao$(empresa: IInstituicao): Observable<IInstituicao> {
      return this.#http
        .post<IInstituicao>(`${this.#url}/api/instituicoes`, empresa)
        .pipe(
          shareReplay(),
          tap((data) => {
    ...
    public httpUpdateInstituica$(id:string,empresa: IInstituicao): Observable<IInstituicao> {
      return this.#http
        .put<IInstituicao>(`${this.#url}/api/instituicoes/${id}`, empresa)
        .pipe(
          shareReplay(),
          tap((data) => {
    ...
    public httpDeleteInstituicao$(id:string | undefined): Observable<IInstituicao> {
      return this.#http
        .delete<IInstituicao>(`${this.#url}/api/instituicoes/${id}`)
        .pipe(
          shareReplay(),
          tap((data) => {
