...
export class FormacoesAcademicasService {
  ...
  #url = environment.apiAuth;
    ...
    public httpListFormacoes$(id: number): Observable<IFormacoesAcademicas[]> {
      return this.#http.get<IFormacoesAcademicas[]>(`${this.#url}/api/formacoes_academicas`).pipe(
        shareReplay(),
        tap((data) => {
    ...
    public httpListFormacoesId$(id: number): Observable<IFormacoesAcademicas[]> {
      return this.#http.get<IFormacoesAcademicas[]>(`${this.#url}/api/formacoes_academicas/${id}`).pipe(
        shareReplay(),
        tap((data) => {
    ...
    public httpRegisterFormacoes$(empresa: IFormacoesAcademicas): Observable<IFormacoesAcademicas> {
      return this.#http
        .post<IFormacoesAcademicas>(`${this.#url}/api/formacoes_academicas`, empresa)
        .pipe(
          shareReplay(),
          tap((data) => {
    ...
    public httpUpdateFormacoes$(id:string,empresa: IFormacoesAcademicas): Observable<IFormacoesAcademicas> {
      return this.#http
        .put<IFormacoesAcademicas>(`${this.#url}/api/formacoes_academicas/${id}`, empresa)
        .pipe(
          shareReplay(),
          tap((data) => {
    ...
    public httpDeleteFormacoes$(id:string | undefined): Observable<IFormacoesAcademicas> {
      return this.#http
        .delete<IFormacoesAcademicas>(`${this.#url}/api/formacoes_academicas/${id}`)
        .pipe(
          shareReplay(),
          tap((data) => {
