...
@Component({
  ...
  imports: [FormsModule, MatFormFieldModule, MatInputModule, MatChipsModule, MatIconModule, MatAutocompleteModule, ButtonPrimaryComponent],
...
export class CadastroVagaDialogComponent {
  ...
  public formXp: FormGroup;
     ...
     constructor(private _dialogRef:MatDialogRef<CadastroVagaDialogComponent>, 
